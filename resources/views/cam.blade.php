                    ...
                    <script>
                        function pageScroll() {
                            var objDiv = document.getElementById(
                                "results"); // Ubah "result" menjadi ID elemen yang ingin Anda gulir otomatis
                            objDiv.scrollTop = objDiv.scrollHeight; // Menetapkan nilai scrollTop ke ketinggian elemen auto-scroll
                        }

                        setInterval(pageScroll, 100); // Call the pageScroll function every 100ms
                    </script>
