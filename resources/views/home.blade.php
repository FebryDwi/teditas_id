...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="navbar-brand" href="index.html"> TEDITAS. </a>
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            ...
            <div class="owl-carousel owl-theme" id="project-slide">
              ...
              >
                <img
                  src="images/project/belajar.jpg"
                  class="img-fluid"
                  alt="project image"
                />
                ...
                <div class="project-info">
                  ...
                  <h3>
                    <a href="https://www.youtube.com/watch?v=4DZnZv3weBw">
              ...
              <div class="item project-wrapper" data-aos="fade-up">
                <img
                  src="images/project/belajar2.jpg"
                  class="img-fluid"
                  alt="project image"
                />
                ...
                <div class="project-info">
                  ...
                  <h3>
                    <a
                      href="https://www.youtube.com/watch?v=mukNGgweHSI&pp=ygUXYmVsYWphcmEgYmFoYXNhIGlzeWFyYXQ%3D"
                    >
              ...
              <div class="item project-wrapper" data-aos="fade-up">
                <img
                  src="images/project/belajar3.jpg"
                  class="img-fluid"
                  alt="project image"
                />
                ...
                <div class="project-info">
                  <small>Video Belajar</small>
                  <h3>
                    <a href="https://www.youtube.com/watch?v=h4hy75JWBdE">
              ...
              <div class="item project-wrapper" data-aos="fade-up">
                <img
                  src="images/project/belajar4.jpg"
                  class="img-fluid"
                  alt="project image"
                />
                ...
                <div class="project-info">
                  <small>Video Belajar</small>
                  <h3>
                    <a href="https://www.youtube.com/watch?v=QUxNzUiWvAY">
              ...
              <div class="item project-wrapper" data-aos="fade-up">
                <img
                  src="images/project/belajar5.jpg"
                  class="img-fluid"
                  alt="project image"
                />
                ...
                <div class="project-info">
                  <small>Video Belajar</small>
                  <h3>
                    <a href="https://www.youtube.com/watch?v=wC9R0Sw6QaY">
        ...
        <div class="row">
          <div class="col">
            <div class="contact-image" data-aos="fade-up">
              <img src="images/TUT.png" class="img-fluid" alt="website" />
            </div>
          </div>
          <div class="col">
            <div class="contact-image" data-aos="fade-up">
              <img src="images/PKM23.png" class="img-fluid" alt="website" />
            </div>
          </div>
          <div class="col">
            <div class="contact-image" data-aos="fade-up">
              <img
                src="images/merdeka_belajar.png"
                class="img-fluid"
                alt="website"
              />
            </div>
          ...
          <div class="col">
            <div class="contact-image" data-aos="fade-up">
              <img src="images/STIKI.png" class="img-fluid" alt="website" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          >
            ...
            <p class="mb-1">
              ...
              Jl. Raya Tidar No.100, Karangbesuki, Kec. Sukun, Kota Malang, Jawa
              Timur 65146
            </p>
          </div>
